...
smiData.Solid(1).CoM = [-10.767328775065327 -0.22775885648831093 -106.05466124641468];  % mm
smiData.Solid(1).MoI = [31508.550862891261 35978.220812381202 29404.213916917306];  % kg*mm^2
smiData.Solid(1).PoI = [-57.023160817414713 -363.57468745226566 -120.76037152139897];  % kg*mm^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(2).mass = 2.619563686431849;  % kg
smiData.Solid(2).CoM = [12.699884328564302 17.930375642989418 -1.0794117975430566];  % mm
smiData.Solid(2).MoI = [7294.1602475928185 8125.268631680794 9019.8688763266964];  % kg*mm^2
smiData.Solid(2).PoI = [-33.654425503898743 -26.773504418132241 809.51782513045418];  % kg*mm^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(3).mass = 3.0910247120214596;  % kg
smiData.Solid(3).CoM = [-39.94992715971577 78.642782866133629 -1.7991591169871086];  % mm
smiData.Solid(3).MoI = [12617.096769002597 13813.151449319368 18010.153313706054];  % kg*mm^2
smiData.Solid(3).PoI = [344.21357768036722 -295.26823603951146 5575.5036917874095];  % kg*mm^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(4).mass = 5.3701264931444914;  % kg
smiData.Solid(4).CoM = [7.8030580764583695 136.04887076360689 2.1226629906909724];  % mm
smiData.Solid(4).MoI = [87244.027683960041 35241.483877061313 61682.245544138052];  % kg*mm^2
smiData.Solid(4).PoI = [733.11002713599316 -28.531514145041069 -405.65477022909789];  % kg*mm^2
